...
public abstract class Item extends BattleCommand implements Comparable<Item>{
	 ...
	 * @throws MaximumStatException: Cannot use an item if it will not improve the hero's fields
	 */
	public abstract void useBattleCommand(Hero hero, Hero target) throws MaximumStatException;
	 ...
	 * @throws MaximumStatException: Cannot use an item if it will not improve the hero's fields
	 */
	public abstract void useBattleCommand(Hero hero, BattleController controller) throws MaximumStatException;
	 ...
	 * @param item the item you wish to retrieve
	 * @return Item: the item you wish to retrieve 
	 */
	public Item getItem()
	{
