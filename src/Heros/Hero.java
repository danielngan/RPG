...
public abstract class Hero implements Comparable<Hero>{
	 ...
	 */
	public Hero(String image, int experience, int level, int health, int abilityPoints, int defenseRating, int speed, String controlledBy)
	{
		this.image = image;
	 ...
	 */
	public final void checkIfEnoughAP(Ability ability)
	{
